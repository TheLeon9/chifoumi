...
if(isset($_POST['finishlose'])){
    $lose += 1;
    $updateLo = $bdd->prepare('UPDATE users SET Lose = ? WHERE Id= ?');
    $updateLo->execute(array($lose , $id));
    $_SESSION['lose'] = $lose;
}
if(isset($_POST['finishwin'])){
    $win += 1;
    $updateW = $bdd->prepare('UPDATE users SET Win = ? WHERE Id= ?');
    $updateW->execute(array($win , $id));
    $_SESSION['win'] = $win;
}
?>
<!DOCTYPE html>
        ...
        <div class="all">
            ...
            <div class="rightdessus" id="right">
                ...
                <?php
                        echo  "<p>" . $nomrobot . " </p>";
                ?>
                <img src="../../assets/images/menu/robothard.png" alt="hard">
            </div>
            ...
            <div class="pierrej" id="lose">
                ...
                echo  "<p> BOUH : " . $u . " </p>";
                ?>
                <p>You earn 1 lose & no level !!</p>
                <div>
                    <form method="post" action="#" autocomplete="off">
                        <input type="submit" value="FNISH" class="restart" name="finishlose" />
                    </form>
                </div>
            </div>
            ...
            <div class="ciseauxj" id="win">
                ...
                echo  "<p> WP : " . $u . " </p>";
                ?>
                <p>You earn 1 Win & 0.5 level !!</p>
                <div>
                    <form method="post" action="#" autocomplete="off">
                        <input type="submit" value="FNISH" class="restart" name="finishwin" />
                    </form>
                </div>
            </div>
